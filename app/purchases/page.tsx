        ...
        <div className="max-w-6xl mx-auto">
          ...
          {!account ? (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-600 to-amber-500 text-white rounded-lg hover:from-amber-700 hover:to-amber-600 transition-all duration-200 font-semibold shadow-md hover:shadow-lg"
              >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {data.purchases.map((purchase) => (
                  <div
                    key={purchase.id}
                    className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md hover:border-amber-300 dark:hover:border-amber-700 transition-all duration-200"
                  >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                          <div className="flex items-center gap-2">
                            ...
                            <Link
                              ...
                              className="text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 font-medium truncate"
                            >
                              {purchase.page.title}
                            </Link>
                          </div>
                        ...
                        {purchase.item.contentUrl ? (
                          <>
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="px-5 py-2.5 bg-gradient-to-r from-amber-600 to-amber-500 text-white rounded-lg hover:from-amber-700 hover:to-amber-600 transition-all duration-200 font-semibold shadow-md hover:shadow-lg text-center flex items-center justify-center gap-2"
                            >
