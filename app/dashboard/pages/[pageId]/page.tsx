              ...
              {page.items.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {page.items.map((item) => (
                    <div
                      key={item.id}
                      className="border-2 border-gray-200 dark:border-gray-700 rounded-xl p-5 hover:border-amber-300 dark:hover:border-amber-700 hover:shadow-md transition-all duration-200 bg-gradient-to-br from-white to-gray-50/30 dark:from-gray-800 dark:to-gray-800/50"
                    >
