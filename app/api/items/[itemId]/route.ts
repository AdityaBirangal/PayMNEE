...
export async function PATCH(
  ...
  try {
    ...
    if (finalType === 'fixed') {
      const finalPrice = priceMnee !== undefined ? priceMnee : existingItem.priceMnee;
    ...
    const item = await prisma.paymentItem.update({
      ...
      data: {
        ...
        ...(type && { type: type }),
        ...(finalType === 'fixed' && priceMnee !== undefined && { priceMnee: priceMnee.trim() }),
        ...(finalType === 'open' && { priceMnee: null }),
